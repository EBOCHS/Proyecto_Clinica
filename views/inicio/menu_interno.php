...
<body class="leading-normal tracking-normal text-white gradient overflow-hidden"
            ...
            <div class="w-full container mx-auto flex flex-wrap items-center justify-between mt-0 py-2">
                ...
                <div class="w-full flex-grow lg:flex lg:items-center lg:w-auto mt-2 lg:mt-0 bg-white lg:bg-transparent text-black p-4 lg:p-0 z-20"
                    ...
                    <ul class="list-reset lg:flex justify-end flex-1 items-center transition duration-1000">
                        <li>
                            <a id="drop-down1"
                                ...
                                focus:outline-none focus:shadow-outline transform transition hover:scale-105 duration-300 ease-in-out">Análisis
                                Técnico
                            ...
                            <div id="drop-menu1"
                                ...
                                <ul class="flex text-center flex-col justify-center items-center">
                                    ...
                                    <li
                                        class="hover:bg-blue-300 transition hover:scale-105 duration-300 ease-in-out text-xl p-1">
                                        <a class="p-2" href="../Documentos_Analisis/documentos_de_analisis.php">Documentos De Analisis</a>
                                    </li>
                        ...
                        <li>
                            ...
                            <a id="drop-down3"
                                class="cursor-pointer mr-3 bg-white hover:bg-blue-300 text-gray-900 font-bold rounded-full mt-4 lg:mt-0 py-2 px-5 shadow 
                            focus:outline-none focus:shadow-outline transform transition hover:scale-105 duration-300 ease-in-out">Mantenimiento
                                de Solicitudes
                                <i class="fas fa-chevron-down"></i></a>
                            <div id="drop-menu3"
                                class="absolute my-3 flex bg-white h-auto rounded-lg overflow-hidden hidden">
                                <ul class="flex text-center flex-col justify-center items-center">
                                    ...
                                    <li
                                        class="hover:bg-blue-300 transition hover:scale-105 duration-300 ease-in-out text-xl p-1">
                                        <a class="p-2" href="../Creacion_Muestras/muestra.php">Crear Muestra Medica</a>
                                    </li>
                                    <li
                                        class="hover:bg-blue-300 transition hover:scale-105 duration-300 ease-in-out text-xl p-1">
                                        <a class="p-2" href="../Creacion_Muestras/asociar.php">Asociar Muestra Medica</a>
                                    </li>
                                    <li
                                        class="hover:bg-blue-300 transition hover:scale-105 duration-300 ease-in-out text-xl p-1">
                                        <a class="p-2" href="../Consulta_Solicitudes/consulta_solicitudes.php">Consulta de Solicitudes</a>
                                    </li>
                                    <li
                                        class="hover:bg-blue-300 transition hover:scale-105 duration-300 ease-in-out text-xl p-1">
                    ...
                    <form action="../../models/LoginModelo.php" method="POST">
                        <a href="login.html"><button id="navAction" name ="cerrar";
                                ...
                                <?php echo $_SESSION['usuario'];?> Cerrar Sesión<i class="fas fa-user-circle m-2"></i>
                            </button>
                        </a>
                    </form>
                </div>
        ...
        <div class="container px-3 mx-auto flex flex-wrap flex-col md:flex-row items-center">
            ...
            <div class="flex flex-col w-full md:w-2/5 justify-center items-start text-center md:text-left">
                ...
                <h1 class="my-4 text-5xl font-bold leading-tight">
                    Bienvenido a la aplicación para usuarios internos
                </h1>
            ...
            <div class="w-full md:w-3/5 py-6 text-center">
                <img class="w-full md:w-4/5 z-50 my-14 ml-24 rounded-xl shadow-xl transform skew-y-2 hover:scale-105 transition duration-700 hover:ease-in-out"
    ...
    <script>
        $("#drop-down1").click(function () {
            $("#drop-menu1").slideToggle(500);
        });
        $("#drop-down2").click(function () {
            $("#drop-menu2").slideToggle(500);
        });

                    ...
                    <div class="flex -mx-3">
                        ...
                        <form action="../../models/SolicitudModelo.php" method="POST">
                            ...
                            <div class="flex -mx-3">
                                ...
                                <div class="flex -mx-3">
                                    <div class="w-full px-3 mb-2">
                                        <label for="" class="text-xs font-semibold px-1">Buscar</label>
                                        <div class="flex">
                                            <div
                                                class="w-10 z-10 pl-1 text-center pointer-events-none flex items-center justify-center">
                                                <!--Boton para mostrar el CUI-->
                                                <button id="search" type="submit"> <i
                            ...
                            <div class="flex -mx-3">
                                ...
                                <div class="flex -mx-3">
                                    ...
                                    <div class="w-full px-3 mb-2">
                                        <label for="" class="text-xs font-semibold px-1">Cancelar</label>
                                        <div class="flex">
                                            <div
                                                class="w-10 z-10 pl-1 text-center pointer-events-none flex items-center justify-center">
                                                <!--Boton para Ocultar-->
                                                <button id="exp_cancelar" type="submit"> <i
                                                        class="fas fa-times-circle cursor-pointer">X</i></button>
                                            </div>
                            ...
                            <div class="flex -mx-3">
                                <div class="w-full px-3 mt-2">
                                    ...
                                    <input type="submit" value="Crear" onclick="return confirmar()" name="Crear_Solicitud"

...
<body class="gradient min-h-screen pt-10 md:pt-4 pb-6 px-2 md:px-0 overflow-hidden">
        ...
        <section class="mt-6">
            ...
            <form class="flex flex-col" method="POST" action="../../models/LoginModelo.php">
                ...
                <div class="flex justify-end">
                    <a href="#" class="text-sm text-gray-900 hover:text-blue-700 hover:underline mb-6">Ha olvidado
                        su contraseña?</a>
                </div>
    ...
    <div class="max-w-lg mx-auto text-center mt-6 mb-6">
        <p class="text-white">No tiene una cuenta? <a href="#" class="font-bold hover:underline">Registrarse</a>.</p>
    </div>

<?php
    ...
    if(isset($_POST['Crear'])){
        ...
        */
        ...
        $valnumexp1 = $C_muestra ->val_numExpediente($cod_solicitud);
        if($Tmuestra!=0){
                ...
                if($cantidad1!=false){
                    if($Umedida1!=false){
                        if($valnumexp1!=false){
                            ...
                            //
                            $cod = "SELECT ID_SOLICITUD ,COD_SOLICITUD FROM SOLICITUD s2 WHERE  COD_SOLICITUD ='$cod_solicitud'";
                            ...
                            if($rows['ID_SOLICITUD']==""){
                                ...
                                $_SESSION['mms']= "CODIGO DE SOLICITUD NO EXISTE EN LA BASE DE DATOS";
                            ...
                            $insert = "INSERT  into MUESTRAS_MEDICAS (codigo_muestra,tipo_muestra,presentacion_muestra,cantidad_muestra,unidad_medida,adjunto,id_solicitud,estado)
                             VALUES ('$COD_MUESTRA','$Tmuestra1','$presentacion','$cantidad','$Umedida1','$adjunto','$id_COD','creado')";
